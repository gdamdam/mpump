...
10. **[Genre Mix Profiles](genre-mix-profiles.md)** — Research-backed mix profiles for 13 genre families with EQ, sidechain, width, and level targets
11. **[Engine Stability](10-engine-stability.md)** — Audio node lifecycle, known pitfalls, and the stability rules that keep the audio thread healthy
