...
const IS_LITE = new URLSearchParams(window.location.search).get("lite") === "true" || new URLSearchParams(window.location.search).get("eco") === "true" || getItem("mpump-perf-mode") === "lite" || getItem("mpump-perf-mode") === "eco";
