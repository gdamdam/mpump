  ...
  return (
    ...
    >
      ...
      <footer className="app-footer" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "0 6px" }}>
        ...
        <span><a className="app-footer-link" href="https://ko-fi.com/gdamdam" target="_blank" rel="noopener noreferrer" style={{ color: "#ff0000", fontWeight: 700, filter: "brightness(2)" }}>Support ♥</a> · <a className="app-footer-link" href="https://github.com/gdamdam/mpump/blob/main/LICENSE" target="_blank" rel="noopener noreferrer">GPL-3.0</a> · Built with Claude Code · <span className="app-footer-link" onClick={() => setShowPrivacy(true)}>No cookies · No personal data</span></span>
      </footer>
    </div>
  );
}
