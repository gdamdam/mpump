    ...
    >
      <header className="header">
        <div className="title">
          ...
          {(() => { const p = new URLSearchParams(window.location.search); const pm = p.get("eco") === "true" ? "eco" : p.get("lite") === "true" ? "lite" : localStorage.getItem("mpump-perf-mode"); return pm === "eco" || pm === "lite" ? <span className="beta-badge" style={{ background: pm === "eco" ? "#ff8c00" : "#888", marginLeft: 3 }} title={pm === "eco" ? "Eco mode: reduced audio for slower devices.\nChange in Settings → Audio." : "Lite mode: animations off.\nChange in Settings → Audio."}>{pm === "eco" ? "ECO" : "LITE"}</span> : null; })()}
