...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "**Effects** — tap to toggle on/off, **hold** to edit parameters. Reverb, Delay, and Duck support per-channel exclusion (EXCL. DRUMS/BASS/SYNTH)",
  ...
  },
  {
    ...
    items: [
      ...
      "**23 bass presets** — Deep Sub, Acid Bass, Wobble, Reese, House Pump, Garage Bass, Trance Sub, UK Sub, Foghorn, Zapper, and more",
      ...
      "**Duck** — auto-duck bass/synth on kick hits, with per-channel exclusion (EXCL. BASS/SYNTH)",
  ...
  },
  {
    ...
    items: [
      ...
      "**Arrangement strip** — horizontal chain of scenes with configurable bar counts (1/2/4/8/16/32) and progress bar",
      ...
      "**Share (⤴)** — share the current song as a link. Recipients open it and hear the full arrangement",
    ],
  },
  {
    title: "Settings",
    items: [
      "**Anti-Clip** — Limiter (default), Hybrid, or Off",
      ...
      "**Bottom Transport** — move play/stop controls to the bottom of the screen (Layout section)",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "**What it does not collect** — no sign-up, no email, no user profile, no fingerprinting, no ad-tech trackers",
      "**What it does collect** — anonymous page counts, anonymous beat counters, and minimal crash reports",
      "**Crash reports** — only the error message and a coarse browser label",
      "**Local storage** — presets, settings, and patterns stay in your browser",
