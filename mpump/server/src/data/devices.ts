...
const synth = (
  ...
  channels: { main: 0 }, rootNote: 45, gateFraction: 0.9, drumGateFraction: 0.1,
...
export const DEVICE_REGISTRY: DeviceConfig[] = [
  ...
  // ── Audio Preview (no MIDI device needed) ───────────────────────────
  drums("preview_drums", "Drums", "__preview_drums__", "var(--preview)", {
    sendClock: false,
  }),
  {
    id: "preview_bass", label: "Bass", portMatch: "__preview_bass__", mode: "bass" as const,
    channels: { main: 1 }, rootNote: 45, gateFraction: 0.5, drumGateFraction: 0.1,
    baseVelocity: 100, hasKey: true, hasOctave: true,
    useProgramChange: false, sendClock: false, accent: "var(--preview)",
  },
  synth("preview_synth", "Synth", "__preview_synth__", "var(--preview)", {
    sendClock: false,
  }),
];
