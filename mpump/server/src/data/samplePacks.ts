...
export const SAMPLE_PACKS: SamplePack[] = [
  {
    // CR-78: analog synthesis (1978) → light, smooth, warm sparkle. NOT digital grit.
    // vs Drumulator: CR-78 is softer transients, lower noise, neutral color (smooth analog)
    id: "cr78", name: "CR-78", genres: "Early Electro, Italo, New Wave",
    voices: {
      36: { tune: 1, decay: 0.18, level: 0.85, click: 0.05, sweepDepth: 0.15, sweepRate: 0.6, filterCutoff: 0.78 },
      38: { tune: 1, decay: 0.18, level: 0.8, noiseMix: 0.4, color: 0.0, filterCutoff: 0.8 },
      42: { tune: 2, decay: 0.2, level: 0.65, color: 0.1, filterCutoff: 0.85 },
      46: { tune: 1, decay: 0.28, level: 0.55, color: 0.05, filterCutoff: 0.82 },
      50: { tune: 1, decay: 0.08, level: 0.7, color: 0.0, filterCutoff: 0.8 },
      49: { tune: 0, decay: 0.5, level: 0.5, color: 0.05, filterCutoff: 0.78 },
    },
  },
  {
  ...
  {
    // LinnDrum: 8-bit @ 28kHz WITH reconstruction filter → warm, soft, natural, rolled-off highs
    id: "linn", name: "LinnDrum", genres: "Synth-Pop, New Wave, Hip-Hop",
    voices: {
      36: { tune: -2, decay: 0.3, level: 1.0, click: 0.18, sweepDepth: 0.2, sweepRate: 0.4, filterCutoff: 0.52 },
      38: { tune: -1, decay: 0.6, level: 1.0, noiseMix: 0.65, filterCutoff: 0.55 },
      42: { tune: 3, decay: 0.5, level: 0.85, color: 0.2, filterCutoff: 0.5 },
      46: { tune: 2, decay: 0.7, level: 0.8, color: 0.2, filterCutoff: 0.5 },
      50: { tune: 2, decay: 0.3, level: 0.9, filterCutoff: 0.55 },
      49: { tune: 1, decay: 1.4, level: 0.7, color: 0.1, filterCutoff: 0.5 },
    },
  },
  {
    // TR-606: analog, 808's thinner sibling — poppy kick, snappy snare, tinny metallic hats
    id: "606", name: "TR-606", genres: "Acid, Minimal, Electro",
    voices: {
      36: { tune: 3, decay: 0.2, level: 0.9, click: 0.15, sweepDepth: 0.35, sweepRate: 0.7 },
      38: { tune: 2, decay: 0.2, level: 0.9, noiseMix: 0.7 },
      42: { tune: 2, decay: 0.25, level: 0.8, color: 0.4 },
      46: { tune: 1, decay: 0.4, level: 0.7, color: 0.4 },
      50: { tune: 4, decay: 0.1, level: 0.85 },
      49: { tune: 1, decay: 0.6, level: 0.6, color: 0.3 },
    },
  },
  {
    // TR-707: 12-bit PCM samples → clean, bright, punchy, glassy digital hats
    id: "707", name: "TR-707", genres: "Italo, Early House, Synth-Pop",
    voices: {
      36: { tune: 1, decay: 0.3, level: 1, click: 0.3, sweepDepth: 0.2, sweepRate: 0.5 },
      38: { tune: 1, decay: 0.3, level: 0.95, noiseMix: 0.6 },
      42: { tune: 1, decay: 0.25, level: 0.85, color: 0.45 },
      46: { tune: 0, decay: 0.4, level: 0.75, color: 0.45 },
      50: { tune: 2, decay: 0.1, level: 0.9 },
      49: { tune: 0, decay: 1.0, level: 0.65, color: 0.3 },
    },
  },
  {
